    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.tthk.ee/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Henri Uusküla</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+372 112</h4>
		<h4 style="font-family:'typo' ">Henri.Jervsongmail.com</h4>
